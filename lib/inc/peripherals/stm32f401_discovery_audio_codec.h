/**
  ******************************************************************************
  * @file    stm32f401_discovery_audio_codec.h
  * @author  MCD Application Team
  * @version V1.0.0
  * @date    11-September-2013
  * @brief   This file contains all the functions prototypes for the 
  *          stm32f401_discovery_audio_codec.c driver.
  ******************************************************************************
  * @attention
  *
...
#ifndef __STM32F401_DISCOVERY_AUDIOCODEC_H
#define __STM32F401_DISCOVERY_AUDIOCODEC_H
...
/** @defgroup STM32F401_DISCOVERY_AUDIO_CODEC 
  * @{
  */    


/** @defgroup STM32F401_DISCOVERY_AUDIO_CODEC_Exported_Types
  * @{
  */

/** @defgroup STM32F401_DISCOVERY_AUDIO_CODEC_Exported_Constants
  * @{
  */ 
...
/* Uncomment the following line to use the default Codec_TIMEOUT_UserCallback() 
   function implemented in stm32f401_discovery_audio_codec.c file.
...
/** @defgroup STM32F401_DISCOVERY_AUDIO_CODEC_Exported_Macros
  * @{
  */ 
...
/** @defgroup STM32F401_DISCOVERY_AUDIO_CODEC_Exported_Functions
  * @{
  */ 
...
/* Codec_TIMEOUT_UserCallback() function is called whenever a timeout condition 
   ...
   define USE_DEFAULT_TIMEOUT_CALLBACK in stm32f401_discovery_audio_codec.h file.
   Typically the user implementation of this callback should reset I2C peripheral
   and re-initialize communication or in worst case reset all the application. */
uint32_t Codec_TIMEOUT_UserCallback(void);

#endif /* __STM32F401_DISCOVERY_AUDIOCODEC_H */
